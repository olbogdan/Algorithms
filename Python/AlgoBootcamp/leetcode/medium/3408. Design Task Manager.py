...
from AlgoBootcamp.array.OptimalOneThirdsRemoval import Solution
...
class TaskManager:
    ...
    def edit(self, taskId: int, newPriority: int) -> None:
        ...
        heapq.heappush(self.topTask, (-newPriority, -taskId))  # push an entry and rely on lazy deletion in execTop
    ...
    def execTop(self) -> int:
        while self.topTask:
            negPriority, negTaskId = heapq.heappop(self.topTask)
            taskId = -negTaskId
            ...
            if taskId in self.taskToPriority and self.taskToPriority[taskId] == priority:
                userId = self.taskToUser.pop(taskId)
                del self.taskToPriority[taskId]
                return userId
        return -1
